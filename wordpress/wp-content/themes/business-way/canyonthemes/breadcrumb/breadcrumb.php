...
class Breadcrumb_Trail {
	...
	public function __construct( $args = array() ) {
        ...
        $show_hide_breadcrumbs =  esc_html(business_way_get_option('business_way_breadcrumb_setting_option'));
        if ($show_hide_breadcrumbs === 'enable'){
            $show_hide_breadcrumbs = true;
        } else {
            $show_hide_breadcrumbs = false;
        }
